...
The reason for the speed difference is very simple; this package works
hard to directly use optimized linear algebra for the matrix vector
products that are at the heart of the computation, and to minimize
unnecessary memory traffic.  So everything should work quite nicely if
your R is built against a decent BLAS / LAPACK.
